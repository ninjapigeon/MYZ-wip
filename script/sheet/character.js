export class MutantYearZeroCharacterSheet extends ActorSheet {
    ...
    printDices() {
        let message = "";
        this.dices.forEach(dice => {
            message = message + "<img width='25px' height='25px' style='border:none;margin-right:2px;margin-top:2px' src='systems/mutant-year-zero/asset/" + dice.type + "-dice-" + dice.value + ".png'/>"
        });
        return message;
    }
